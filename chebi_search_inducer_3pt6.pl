...
# open output file
my $all_inducers_filename = './output/inducers_3pt6_with_chebi.tsv';
my $chebi_found_filename = './output/inducers_3pt6_chebi_found.tsv';
my $possible_chebi_filename = './output/inducers_3pt6_possible_chebi.tsv';
my $no_chebi_filename = './output/inducers_3pt6_no_chebi.tsv';
