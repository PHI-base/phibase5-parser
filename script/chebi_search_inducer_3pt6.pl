...
open (INDUCER_FILE, "../input/inducer_chemicals_in_phibase_3pt6.tsv") or die "Error opening input file\n";
...
# open output file
my $all_inducers_filename = '../mapping/inducers_3pt6_with_chebi.tsv';
my $chebi_found_filename = '../mapping/inducers_3pt6_chebi_found.tsv';
my $possible_chebi_filename = '../mapping/inducers_3pt6_possible_chebi.tsv';
my $no_chebi_filename = '../error/inducers_3pt6_no_chebi.tsv';
