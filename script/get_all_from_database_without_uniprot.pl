...
"New PHI-base Acc\tOld PHI-base Acc\tUniProt Acc\tGene Name (PHI-base)\tPathogen Taxon\tDisease\tHost Taxon\tCotyledons\tGO Annotations (PHI-base)\tPhenotype Outcome\tDefects\tInducers\tCAS Registry IDs\tChEBI IDs\tFRAC Codes\tFRAC Mode of Action\tFRAC Target Site\tFRAC Group\tFRAC Chemical Group\tFRAC Common Name\tFRAC Resistance Risk\tFRAC Comment\tExperiment Specifications\tCurators\tSpecies Experts\tPubMed IDs\tCuration Date\n";
...
#  print DATABASE_DATA_FILE "$uniprot_accessions\t$phibase_gene_names\t$uniprot_gene_names\t$uniprot_protein_names\t$uniprot_embl_accessions\t$path_taxons\t";
  print DATABASE_DATA_FILE "$uniprot_accessions\t$phibase_gene_names\t$path_taxons\t";
